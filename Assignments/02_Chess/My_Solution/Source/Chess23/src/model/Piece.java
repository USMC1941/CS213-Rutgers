...
public abstract class Piece {
     ...
     */
    protected boolean doActualMoveIsPromotion(BoardIndex targetIndex, Promotion promotion/*Piece promToPiece*/, boolean rollback) {
        Map<String, Piece> pieceMap = chessBoard.getPieceMap();
        //
        BoardIndex sourceIndex = getBoardIndex();
        //
     ...
     * @return True if rollback can happen, false otherwise
     */
    ...
    protected boolean isNoneInBetween(DirectionDistance dd) {
        ...
        for (int i = 1; i < dd.getDistance(); i++) {
            ...
            BoardIndex oneIndex = new BoardIndex(boardIndex.fileIndex + i * deltaFile,
                    boardIndex.rankIndex + i * deltaRank);
            //
