 ...
 * <p>
 * In this state all buttons except '=' and '.' are enabled.
 *
...
class CalcOp1FloatState extends CalcState {
    ...
    * Digit buttons are always enabled. Operator and 'C' buttons must already be enabled
    * at the time this state is entered, and remain enabled.
