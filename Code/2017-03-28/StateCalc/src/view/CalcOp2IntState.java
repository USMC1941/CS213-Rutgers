...
/**
 * This class represents the integer second operand state. 
 ...
 * <p>
 * In this state all buttons are enabled.
 *
...
class CalcOp2IntState extends CalcState {
    ...
    * The operator and '=' buttons are re-enabled.
    */
   void enter() {
    ...
    * Event source is a digit, decimal, operator, clear, or '='.
