...
/**
 * This class represents the clear state. In this state, the display shows 0, and all
 * buttons except = are enabled. Operand 1 is set to 0.
...
class CalcClearState extends CalcState {
    ...
    * Sets display to "0".
    * Enables decimal and operator buttons.
    * Disables the '=' button.
    */
   void enter() {
   ...
   /**
    * Processes an event that is fired when in clear state.
    * Event source is any button except '='
    * If source is clear, then remain in this state
