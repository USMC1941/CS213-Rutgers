...
public class AddEditMovie extends AppCompatActivity {
   ...
   public void save(View view) {
      ...
      if (name == null || name.length() == 0 || year == null || year.length() == 0) {
         ...
         bundle.putString(com.example.sesh.movies.MovieDialogFragment.MESSAGE_KEY, "Name and year are required");
         DialogFragment newFragment = new com.example.sesh.movies.MovieDialogFragment();
